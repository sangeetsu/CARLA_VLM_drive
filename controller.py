...
#
#
# Edits made by Joshua Elkins and Sangeet Sankaramangalam Ulhas
...
class PIDLongitudinalController():
    ...
    # Edited this code to implement an integral overflow check
    def _pid_control(self, target_speed, current_speed):
        ...
        if finalVal != clamping:
            block1 = True
        if (finalVal > 0 and error > 0) or (finalVal < 0 and error < 0):
            block2 = True
...
class PIDLateralController():
    ...
    # edits made to this code to implement an integral overflow check
    def _pid_control(self, waypoint, vehicle_transform):
        ...
        if finalVal != clamping:
            block1 = True
        if (finalVal > 0 and _dot > 0) or (finalVal < 0 and _dot < 0):
            block2 = True
        if block1 and block2:
            self._integrator = False
        else:
